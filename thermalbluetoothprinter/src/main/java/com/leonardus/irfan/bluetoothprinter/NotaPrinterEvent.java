...
public class NotaPrinterEvent extends BluetoothPrinter {
    /*
    ...
    */
    ...
    public NotaPrinterEvent(Context context){
        super(context);
    }

    public NotaPrinterEvent(Context context, Bitmap bmp){
        super(context);
       ...
       // header = PrintFormatter.decodeBitmap(transaksi.getIcon());
        ...
        try {
            ...
            if(header != null){
                ...
                outputStream.write(String.format(transaksi.getNama_Ibadah()).getBytes());
            ...
            outputStream.write(String.format("Tempat      : %s\n", transaksi.getTempat()).getBytes());
